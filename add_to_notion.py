#!/usr/bin/env python3
"""Script to add all misc-projects to the Notion Projects database."""
...
DATABASE_ID = "2ffea6ba-eea7-8171-ba58-e273f5b9ab7f"
...
def create_page(project):
    """Create a page in the Notion database for a project."""
    data = {
